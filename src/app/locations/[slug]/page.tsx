        ...
        <ScrollReveal delay={100}>
          <div className="max-w-2xl mb-12">
            <p className="text-muted-foreground leading-relaxed">
              The work doesn&apos;t change by location: SEO to get you
              ranking on Google, and GEO to get you found and recommended by
              ChatGPT, Gemini, and Perplexity — plus the accessibility
              issues holding you back, fixed on an ongoing basis. The same
              honest, measured process outlined on{" "}
